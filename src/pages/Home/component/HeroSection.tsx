...
const HeroSection = () => {
  return (
    <div className="relative md:flex-[2.5] h-109 md:overflow-hidden">
      ...
      <CImg className="absolute inset-0 w-full h-full rounded-3xl sm:object-right" src={bannerTop} alt="메인 베너" />
    </div>
  );
};
